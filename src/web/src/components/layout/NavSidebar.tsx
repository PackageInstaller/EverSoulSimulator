...
const NAV_ITEMS: NavItemConfig[] = [
  ...
  { page: 'settings',  i18nKey: 'admin.settings',  icon: Settings,        colorClass: 'text-slate-500 dark:text-slate-400',   activeGradient: 'from-slate-500 to-slate-600',  activeShadow: 'shadow-slate-500/30' },
]
