...
extern "C"
{
    ...
    __attribute__((constructor)) static void eversoul_entry()
    {
        ...
        // MuMu ARM + Eversoul 1.34.101 stalls in LIAPP bootstrap if every
        // libcawwyayy thread is redirected. Keep the root/file/kill bypass
        // active, but let the bootstrap threads run.
