...
.method private static entityFromConnection(Ljava/net/HttpURLConnection;)Lcom/android/volley/http/HttpEntity;
    .locals 2

    new-instance v0, Lcom/android/volley/http/HttpEntity;

    invoke-direct {v0}, Lcom/android/volley/http/HttpEntity;-><init>()V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lcom/android/volley/http/HttpEntity;->setContent(Ljava/io/InputStream;)V

    invoke-virtual {p0}, Ljava/net/HttpURLConnection;->getContentLength()I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/android/volley/http/HttpEntity;->setContentLength(I)V

    invoke-virtual {p0}, Ljava/net/HttpURLConnection;->getContentEncoding()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/volley/http/HttpEntity;->setContentEncoding(Ljava/lang/String;)V

    invoke-virtual {p0}, Ljava/net/HttpURLConnection;->getContentType()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/android/volley/http/HttpEntity;->setContentType(Ljava/lang/String;)V
...
.method public performRequest(Lcom/android/volley/Request;Ljava/util/Map;)Lcom/android/volley/http/HttpResponse;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Lcom/rikka/redirect/URLHook;->redirect(Ljava/lang/String;)Ljava/lang/String;
    move-result-object v0
    ...
    new-instance p1, Lcom/android/volley/http/HttpResponse;
    ...
    invoke-direct {p1, v0, v1}, Lcom/android/volley/http/HttpResponse;-><init>(ILjava/lang/String;)V

    invoke-static {p2}, Lcom/android/volley/toolbox/HurlStack;->entityFromConnection(Ljava/net/HttpURLConnection;)Lcom/android/volley/http/HttpEntity;

    move-result-object v0

    invoke-virtual {p1, v0}, Lcom/android/volley/http/HttpResponse;->setEntity(Lcom/android/volley/http/HttpEntity;)V
    ...
    invoke-virtual {p1, v1, v0}, Lcom/android/volley/http/HttpResponse;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
